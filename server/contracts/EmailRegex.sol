...
library EmailRegex {
  struct State {
    bool accepts;
    function (uint) internal pure returns (uint) func;
  }

  function state(uint id) internal pure returns (State memory _state) {
    if (id == 1) {
  ...
  function s1(uint c) internal pure returns (uint) {
  ...
  function s2(uint c)  internal pure  returns (uint) {
    if (c >= 37 && c <= 37 || c >= 43 && c <= 43 || c >= 45 && c <= 45 || c >= 46 && c <= 46 || c >= 48 && c <= 57 || c >= 65 && c <= 90 || c >= 95 && c <= 95 || c >= 97 && c <= 122) {
      return 3;
    }
    if (c >= 64 && c <= 64) {
  ...
  function s3(uint c)  internal pure returns (uint) {
    if (c >= 37 && c <= 37 || c >= 43 && c <= 43 || c >= 45 && c <= 45 || c >= 46 && c <= 46 || c >= 48 && c <= 57 || c >= 65 && c <= 90 || c >= 95 && c <= 95 || c >= 97 && c <= 122) {
      return 3;
    }
    if (c >= 64 && c <= 64) {
  ...
  function s4(uint c) internal pure returns (uint) {
  ...
  function s5(uint c) internal pure returns (uint) {
    if (c >= 46 && c <= 46) {
      return 6;
    }
  ...
  function s6(uint c) internal pure returns (uint) {
    if (c >= 46 && c <= 46) {
      return 6;
    }
  ...
  function s7(uint c) internal pure returns (uint) {
    if (c >= 46 && c <= 46) {
      return 6;
    }
    if (c >= 47 && c <= 47 || c >= 48 && c <= 57 || c >= 58 && c <= 64 || c >= 65 && c <= 90 || c >= 91 && c <= 95 || c >= 97 && c <= 122) {
  ...
  function s8(uint c) internal pure returns (uint) {
    if (c >= 46 && c <= 46) {
      return 6;
    }
    if (c >= 47 && c <= 47 || c >= 48 && c <= 57 || c >= 58 && c <= 64 || c >= 91 && c <= 95) {
  ...
  function s9(uint c) internal pure returns (uint) {
    if (c >= 46 && c <= 46) {
      return 6;
    }
    if (c >= 47 && c <= 47 || c >= 48 && c <= 57 || c >= 58 && c <= 64 || c >= 91 && c <= 95) {
  ...
  function s10(uint c) internal pure returns (uint) {
    if (c >= 46 && c <= 46) {
      return 6;
    }
    if (c >= 47 && c <= 47 || c >= 48 && c <= 57 || c >= 58 && c <= 64 || c >= 91 && c <= 95) {
