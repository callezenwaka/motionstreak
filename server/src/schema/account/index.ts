 ...
 */
 export const addAccount = async (
  ...
  context: any) => {
    ...
    // const {displayName, phoneNumber, email, photoURL, role, isActive, isActivated } = req.body;
    ...
    const result = await accountsContract.addAccount(req.address, req.affiliate, args.displayName, args.phoneNumber, args.email, args.photoURL, args.role, args.isActive, args.isActivated);
    await result.wait();
